...
const hotelSchema = new mongoose.Schema({
  ...
  google_map: { type: String, required: false }, // 호텔 설명
  ...
  surrounding: { metro: [String], airport: [String], train: [String] }, // 주변 정보
  amenities: [String], // 주변 정보
  isFreeAmenities: [String], // 주변 정보
  check_in_start: { type: String },
  ...
  // Update the rooms field to reference Room model
  rooms: [],
  location_category: { type: String }, // 위치 카테고리
  validFrom: { type: Date }, // 유효 시작일
  ExpiredAt: { type: Date }, // 만료일
