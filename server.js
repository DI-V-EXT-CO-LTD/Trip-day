...
mongoose
  .connect(process.env.MONGODB_URI || "mongodb://localhost:27017/invoices", {})
  .then(() => {
...
if (useHttps) {
  const httpsOptions = {
    key: fs.readFileSync("trip-day.key"), // 개인 키 파일
    cert: fs.readFileSync("ssl/trip-day.crt"), // 인증서 파일
    ca: fs.readFileSync("ssl/gd_bundle-g2-g1.crt"), // 체인 인증서
  };
